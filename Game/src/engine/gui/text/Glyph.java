...
public class Glyph {
	...
	/** 2D position of the Text onScreen */
	private Vector2f surface;
	/** 2D width and height of the Text onScreen */
	private Vector2f offset;
	/** 2D offset of the character from the cursor of the Text onScreen */
	...
	public String toString() {
		return new String("ID: " + (int) this.id + " Position : " + this.position.x + " " + this.position.y
				+ " Surface : " + this.surface.x + " " + this.surface.y + " Offset : " + this.offset.x + " "
				+ this.offset.y + " Advance : " + this.advance);
	}
