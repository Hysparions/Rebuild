...
public class Sprite {
	...
	public void draw() {
		...
		spriteProjection.translate(rectangle.x / (float)texture.width(), rectangle.y / (float)texture.height(), 0.0f);
		spriteProjection.scale(rectangle.z / (float)texture.width(), rectangle.w / (float)texture.height(), 1.0f);
